...
int main(int argc, char *argv[]) {
  ...
  // beam four-momenta
  // e+ e- -> X
  FourVector b1(0, 0,  Eb, Eb);
  FourVector b2(0, 0, -Eb, Eb);
  ...
  for (nEvents = 0; nEvents < maxEvents; ++nEvents) {
    double Ebv = Eb;
    if (randomCoM > 0) Ebv += ((((double)rand())/((double) RAND_MAX))-0.5)*randomCoM;
    ...
    FourVector beam1(0,0,-Ebv,Ebv);
    FourVector beam2(0,0,Ebv,Ebv);
