...
inline number fd_QEDPropagatorZ(FourVector &p, int mu, int nu) {
...
inline matrix fd_Fermion(bool f, bool anti, int s, FourVector &p, double mass = 0.5109e-3) {
...
double ProcessComp::getAmp(FourVector vb1, FourVector vb2, std::vector<FourVector> &o) {
  ...
  FourVector p = in[0]+in[1];
  FourVector p2 = in[0]-out[0];
  double charge = -1;
